...
public class HelloController {
	...
	public String getHelloWorldWithParams(@PathVariable("str") String str) {
	...
	public void deleteHelloWorld() {
		logger.info("delete HelloWorld endpoint called!");
	}
	
	@DeleteMapping("/helloworld/{id}")
	public void deleteHelloWorld(@PathVariable("id") Integer id) {
		logger.info("delete HelloWorld endpoint called for id:" + id);
	}
}
